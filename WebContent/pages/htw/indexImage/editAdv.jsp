...
<div class="x-panel" style="width: 100%">
    ...
    <div align="center" style="width: 100%">
        <s:form action="saveAdv"  id="save" validate="true" method="POST" enctype ="multipart/form-data">
            <br/>
            <fieldset style="width: 95%; padding:10px 10px 10px 10px;">
                ...
                <table width="90%">
                    ...
                    <tr>
                        ...
                        <td align="left" ><s:textfield id="startTime" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate"  readonly="readonly"
                                                       name="model.startTime" cssClass="required" ></s:textfield><font color="red" id="createTimemsg">&nbsp;*</font>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">结束日期：</td>
                        <td align="left" ><s:textfield id="endTime"  onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate"  readonly="readonly"
                                                       name="model.endTime" cssClass="required"></s:textfield><font color="red" id="createTimemsg">&nbsp;*</font>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">类型：</td>
                        <td>
                            <s:select list="#{'0':'首页轮播','3':'广告'}" name="model.type" cssClass="required" cssStyle="width:200px;"></s:select>
                            <font color="red">【建议图片大小400*300或此大小的倍数】*</font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align:left;">
                            <select name="aptId" id="aptId" >
                                <c:forEach items="${apList}" var="apt">
                    ...
                    <tr>
                        ...
                        <td class="simple" align="left" colspan="1">
                            <s:textfield rows="3" id="advUrl" name="advUrl" cols="50"></s:textfield>
                        </td>
                    </tr>
                    <tr>
                        <td  align="right">
                            内容：</td>
                        <td class="simple" align="left" colspan="1">
                            <textarea rows="3" id="contentId" name="content" cols="50"></textarea>
                        </td>
                    </tr>
                </table>
            </fieldset>
