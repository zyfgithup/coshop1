...
<head>
  ...
  <script type="text/javascript" src="${ctx}/pages/admin/security/user/changePassword.js"></script>
</head>
<body>
<div class="x-panel">
  ...
  <div class="x-panel-body">
    ...
    <table width="70%" align="center">
	  <tr>
		<td align="center">
		<s:form action="user/changePassword" theme="simple" validate="true" method="POST" id="change">
		  ...
		  <fieldset style="margin: 10px;">
			...
			<table>
			  <tr>
				...
				<td width="220" class="simple" style="text-align: left;">
				  <s:password cssClass="required" name="oldPassword" id="oldPassword" theme="simple" size="25" />
				  <font color="red">*</font>
				</td>
				<td width="130"></td>
			  </tr>
			  <tr>
				...
				<td class="simple" style="text-align: left;">
				  <s:password name="model.password" id="pwd" theme="simple" size="25" cssClass="required"
			  ...
			  <tr>
				...
				<td class="simple" style="text-align: left;">
				  <s:password name="model.confirmPwd" id="repwd" theme="simple" size="25" 
				    cssClass="passwordCheck required" />
				  <font color="red">*</font>
				</td>
				<td id="pwdRes"></td>
			  </tr>
		  ...
		  <table width="410">
		    <tr>
			  <td colspan="2" align="center" class="font_white">
			    ...
			    <a href="${ctx}/pages/admin/security/user/user.jsp" class="button" style="color: #000000">&nbsp;返 回&nbsp;</a>
			  </td>
			</tr>
		  </table>
		</s:form>
