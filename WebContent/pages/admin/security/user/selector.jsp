...
Ext.onReady(function(){
    ...
    tree = new Tree.TreePanel({
        ...
        "click":function(node, e){
        	document.getElementById('iframe_agent').src="${ctx}/security/user/selectCompany.do?model.region.id=" + node.attributes.id ;        	
          }
        }
...
<div>
 <table width="100%">
  <tr>
	  ...
	  <td>	
		<div >
		<iframe name="iframe_agent" id="iframe_agent" src="${ctx}/security/user/selectCompany.do?model.region.id=${param.regionId}" style="HEIGHT:485px; WIDTH: 546px;" frameborder="0" scrolling="no"></iframe>
		</div>
	   </td>
   </tr>
</table>
