    ...
    <div class="x-toolbar">
      <table width="99%">
        <tr>
         ...
         <table> 
           <tr>
             <td><a href="${ctx}/security/role/index.do"><img src="${ctx}/images/icons/house.gif"/> 角色管理首页</a></td>
             <td><span class="ytb-sep"></span></td>
             <td><a href="${ctx}/security/role/editNew.do"><img src="${ctx}/images/icons/add.gif"/> 新建角色</a></td>
             <td><span class="ytb-sep"></span></td>
