...
<div class="x-panel">
	...
	<div style="float: left;">库存盘点查询</div>
	</div>
...
<div class="x-toolbar">
   <table width="100%">
     <tr>
     <td> 
        <form action="${ctx}/stock/check/checkIndex.do" method="post">   
...
<ec:table items="items" var="item" retrieveRowsCallback="limit" sortRowsCallback="limit" 
	...
	<ec:row>
	   <ec:column width="30" property="_No" title="No."
		...
		<ec:column width="150" property="checkNo" title="盘点单号" style="text-align:center"/>
		<ec:column width="220" property="storage.name" ellipsis="true" title="仓库" />
		<ec:column width="100" property="createTime" title="创建时间" cell="date" style="text-align:center"/>
		<ec:column width="250" property="user.name" ellipsis="true" title="创建人" style="text-align:center"/>
