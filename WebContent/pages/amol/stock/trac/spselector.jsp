...
Ext.onReady(function(){
    ...
    tree = new Tree.TreePanel({
        ...
        "click":function(node, e){
        	document.getElementById('iframe_product').src="${ctx}/stock/stockShowIndex.do?model.products.prosort.id=" + node.attributes.id +"&model.storage.id=${storageId}";
...
<div>
 <table width="100%" >
  <tr>
	  ...
	  <td>	
		<div >
		<iframe name="iframe_product" id="iframe_product" src="${ctx}/stock/stockShowIndex.do?model.storage.id=${storageId}" style="HEIGHT:485px; WIDTH: 546px;" frameborder="0" scrolling="no"></iframe>
		</div>
	   </td>
   </tr>
</table>
