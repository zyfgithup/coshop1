...
<table width="100%">
	<tr>
		...
		<table>
			<tr>
				<td><a href="${ctx}/base/product/distributor/myTjIndex.do"><img src="${ctx}/images/grid/filterArrow.gif" style="width: 12px; height: 12px;"/>&nbsp;返回&nbsp;&nbsp;</a></td>
			</tr>
		</table>
		</td>
	</tr>
...
<s:form action="tjcjzybc" validate="true" method="POST" enctype ="multipart/form-data" theme="simple">
	<table width="78%" height="50%" align="center">
		<tr>
			...
			<table width="100%" height="50%" align="center">
				...
				<tr>
					<td align="right">上架数量：</td>
					<td align="left" ><s:textfield id="maxCount" cssStyle="width:145px;"
						name="model.maxCount" />
					</td>
				</tr>
				<tr>
