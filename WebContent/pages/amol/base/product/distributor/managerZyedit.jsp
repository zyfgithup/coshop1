...
function supper(){
	...
	if(cus!=null){
			window.location.href="${ctx}/base/product/distributor/managerTemplateProductUI.do?model.id="+cus.id;
...
<table width="100%">
	<tr>
		...
		<table>
			<tr>
				<td><a href="${ctx}/base/product/distributor/managerIndexProductCun.do"><img src="${ctx}/images/grid/filterArrow.gif" style="width: 12px; height: 12px;"/>&nbsp;返回&nbsp;&nbsp;</a></td>
			</tr>
		</table>
		</td>
	</tr>
...
<s:form action="managerSave" validate="true" method="POST" enctype ="multipart/form-data" theme="simple">
...
function RegCheck(id){
	...
	else if($("#"+id).val().split(".")[1].length==0||$("#"+id).val().split(".")[0].length==0){
		$("#"+id).val("");
	}
	else{}
}
