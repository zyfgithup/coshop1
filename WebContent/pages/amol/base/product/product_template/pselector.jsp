...
pageContext.setAttribute("storageid",storageid);
%>
<title>选择商品</title>
<style type="text/css">
 .isStatusNo{
...
Ext.onReady(function(){
    ...
    tree = new Tree.TreePanel({
        ...
        "click":function(node, e){
        	document.getElementById('iframe_product').src="${ctx}/base/product/purchaseshowIndex.do?model.prosort.id=" + node.attributes.id +"&model.supplier.id=${sid}&storageid=${storageid}";        	
...
<div>
 <table width="100%" >
  <tr>
	  ...
	  <td>	
		<div >
		<iframe name="iframe_product" id="iframe_product" src="${ctx}/base/product/purchaseshowIndex.do?status=1&model.supplier.id=${sid}&storageid=${storageid}" style="HEIGHT:485px; WIDTH: 586px;" frameborder="0" scrolling="no"></iframe>
		</div>
	   </td>
   </tr>
</table>
