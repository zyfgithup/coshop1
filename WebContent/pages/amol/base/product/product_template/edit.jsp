...
<body>
<div class="x-panel">
<div class="x-panel-header">编辑商品模板信息</div>
<div class="x-toolbar">
<table width="100%">
	<tr>
		<td align="right">
		<table>
			<tr>
				<td><a href="${ctx}/base/product/productTemplate/index.do"><img src="${ctx}/images/grid/filterArrow.gif" style="width: 12px; height: 12px;"/>&nbsp;返回&nbsp;&nbsp;</a></td>
			</tr>
		</table>
		</td>
	</tr>
...
<s:form action="save" validate="true" method="POST" enctype ="multipart/form-data" theme="simple">
	<table width="78%" height="50%" align="center">
		<tr>
			...
			<!-- <fieldset style="margin: 10px;"><legend>编辑商品模板基本信息</legend> -->
			<table width="100%" height="50%" align="center">
				...
				<!-- tr>
					...
					<td align="left" ><s:textfield id="subtitle" cssStyle="width:300px;"
						name="model.subtitle" cssClass="required" /><font color="red">&nbsp;*</font>
					</td>
				</tr>
