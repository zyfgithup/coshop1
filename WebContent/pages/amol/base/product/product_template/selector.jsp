...
Ext.onReady(function(){
    ...
    tree = new Tree.TreePanel({
        ...
        "click":function(node, e){
        	document.getElementById('iframe_product').src="${ctx}/base/product/product_template/showIndex.do?model.prosort.id=" + node.attributes.id ;        	
...
<div class="x-panel-header" style="border: 0px;">
 <table width="100%">
    <tr>
      <td width="80" align="center"><b>选择模板商品</b></td>
...
<div>
 <table width="100%" >
  <tr>
	  ...
	  <td>	
		<div >
		<iframe name="iframe_product" id="iframe_product" src="${ctx}/base/product/productTemplate/showIndex.do?status=1" style="HEIGHT:485px; WIDTH: 791px;" frameborder="0" scrolling="no"></iframe>
		</div>
	   </td>
   </tr>
</table>
