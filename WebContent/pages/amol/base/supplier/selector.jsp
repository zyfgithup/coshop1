...
Ext.onReady(function(){
    ...
    tree = new Tree.TreePanel({
        ...
        "click":function(node, e){
        	document.getElementById('iframe_supplier').src="${ctx}/base/supplier/showIndex.do?model.region.id=" + node.attributes.id ;        	
...
<div>
 <table width="100%" >
  <tr>
	  ...
	  <td>	
		<div >
		<iframe name="iframe_supplier" id="iframe_supplier" src="${ctx}/base/supplier/showIndex.do" style="HEIGHT:485px; WIDTH: 546px;" frameborder="0" scrolling="no"></iframe>
		</div>
	   </td>
   </tr>
</table>
