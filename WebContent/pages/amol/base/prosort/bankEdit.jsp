...
<div class="x-panel-header">编辑会员类型</div>
<div class="x-toolbar">
<table width="100%">
	<tr>
		<td align="right">
		<table>
			<tr>
				<td><a href="${ctx}/base/prosort/banksTableIndex.do"><img src="${ctx}/images/grid/filterArrow.gif" style="width: 12px; height: 12px;"/>&nbsp;返回&nbsp;&nbsp;</a></td>
			</tr>
		</table>
		</td>
	</tr>
...
<s:form action="mersave" id="save" validate="true" method="POST" enctype ="multipart/form-data" >
	...
	<table width="100%" align="center">
		<tr>
			<td align="right" width="300px">所属会员类型：</td>
			<td class="simple" align="left">
			    <span id='comboxWithTree' style="width: 120px;"></span>
			    <input type="hidden" value="3" name="model.type"/>
		...
		<tr>
			...
			<td class="simple" align="left" colspan="3">
				<s:textfield  id="bankType" name="model.name" cssClass="required" cssStyle="width:140px;"></s:textfield >
				<font color="red">*</font>
			</td>
			<td class="simple" align="left">
			</td>
