...
<div class="x-panel-header" style="border: 0px;">
 <table width="100%">
    <tr>
      <td width="80" align="center"><b>选择APP用户</b></td>
...
<div>
 <table width="100%" >
  <tr>
	  ...
	  <td>	
		<div >
		<iframe name="iframe_product" id="iframe_product" src="${ctx}/appuser/manager/getCheckUsers.do?userId=<%=request.getParameter("id") %>" style="HEIGHT:485px; WIDTH: 586px;" frameborder="0" scrolling="no"></iframe>
		</div>
	   </td>
   </tr>
</table>
