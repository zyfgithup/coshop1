...
Ext.onReady(function(){
    ...
    tree = new Tree.TreePanel({
        ...
        "click":function(node, e){
        	document.getElementById('iframe_agent').src="${ctx}/user/agent/selectAgent.do?model.region.id=" + node.attributes.id ;        	
          }
        }
...
<div>
 <table width="100%">
  <tr>
	  ...
	  <td>	
		<div >
		<iframe name="iframe_agent" id="iframe_agent" src="${ctx}/user/agent/selectAgent.do" style="HEIGHT:485px; WIDTH: 546px;" frameborder="0" scrolling="no"></iframe>
		</div>
	   </td>
   </tr>
</table>
