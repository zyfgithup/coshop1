...
<div align="center" style="width: 100%">
	...
	<table width="100%" align="left">
		<tr>
			...
			<td width="213" class="simple" align="left"><fmt:formatDate value="${ model.sdate}" pattern="yyyy-MM-dd"/></td>
		</tr>

		<tr>
			<td align="right">供&nbsp;应&nbsp;商：</td>
			<td class="simple" align="left">${model.supplier.name}
			</td>
		...
		<tr>
			...
			<c:if test="${model.paytype==0 }">预付款</c:if>
			<c:if test="${model.paytype==1 }">全款</c:if>
			</td>
		</tr>
		<tr>
		...
		<td align="right" >
			...
			<td class="simple" align="left">${ model.remark }</td>
		
		</tr>
		<tr>
			<td align="right">订单编号：</td>
			<td colspan="3" class="simple" align="left">${ model.orderno }</td>
		</tr>
...
<script type="text/javascript">
	...
	function exportExcel(id){
		 window.location = '${ctx}/purchase/exportExcel.do?model.id='+id;
	}
</script>
