...
function xdcx(){
	...
	form1.action="${ctx}/purchase/returns/index.do?model.sno="+sno.value+"&model.supplier.name="+sid.value;
	form1.submit();
}
...
<div class="x-panel-header" >
	<div style="float: left;">退货详单查询</div>
	...
	<ec:row>
		...
		<ec:column width="110" property="purchase.sno" title="单号" style="text-align:center"/>
		<ec:column width="80" property="purchase.sdate" title="日期" style="text-align:center" cell="date"/>
		...
		<ec:column width="80" property="products.name" title="商品" />
		<ec:column width="80" property="products.stardard" title="规格" />
