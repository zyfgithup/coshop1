...
function xdcx(){
	...
	form1.action="${ctx}/purchase/index.do?model.sno="+sno.value+"&model.supplier.name="+sid.value;
	form1.submit();
}
...
<div class="x-panel-header" >
	<div style="float: left;">入库详单查询</div>
 ...
 <div class="x-toolbar">
      <table width="99%">
        <tr>
         <s:form action="index" theme="simple" id="form1">
        	...
        	<td>开始日期</td>
        	<td><input id="startDate" name="startDate" size="10"  value='${startDate}' onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'endDate\')}',skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" class="Wdate"  readonly="readonly"/>
	...
	<ec:row>
		...
		<ec:column width="70" property="purchase.sdate" title="日期" style="text-align:center" cell="date"/>
		<ec:column width="90" property="purchase.supplier.name" title="供应商" >
		...
		<ec:column width="60" property="purchase.storage.name" title="仓库" />
		...
		<ec:column width="60" property="amount" title="金额" style="text-align:right" format="###,##0.00"  cell="number"/>
	</ec:row>
