...
<script type="text/javascript" src="${ctx}/pages/amol/database/index.js"></script>
...
function removeBackup(id){
    if(confirm('确认要删除这条备份记录吗？')){
        window.location.href="${ctx}/databackup/remove.do?model.id=" + id;
    }	
}
</script>
</head>
...
<ec:table items="items" var="item" retrieveRowsCallback="limit" sortRowsCallback="limit" 
	...
	<ec:row>
		...
		<ec:column width="140" property="_0" title="操作" style="text-align:center" sortable="false">
			<a href="#" onclick="restoreData('${item.id}')" title="数据库恢复" >还原</a>|
