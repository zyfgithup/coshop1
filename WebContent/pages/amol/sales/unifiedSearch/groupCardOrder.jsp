...
<div class="x-panel-header" >
	<div style="float: left;">销售查询【团购】</div>
	<div style="float: right;">
	</div>
</div>

<div class="x-toolbar">
  <form action="${ctx }/salesEnquiries/groupCardIndex.do" method="post">
          	<%-- &nbsp;&nbsp;单子类型:<s:select list='listTypeMap' name="listType"></s:select>   --%>
          	   <input type="hidden" value="g" name="model.salesType"/>
	                      单号:<s:textfield name="model.salesNo" size="17" id="salesNo"/> 
	                      用户:<s:textfield name="model.user.name" size="10" id="name"/>
...
<ec:table items="items" var="item" retrieveRowsCallback="limit" sortRowsCallback="limit" 
		action="${ctx }/salesEnquiries/groupCardIndex.do" 
		useAjax="false"
		doPreload="false" 
