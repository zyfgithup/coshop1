...
<%
	response.setHeader("Content-disposition","attachment; filename=ReceiveCard.xls"); 
%>
...
<div class="x-panel-header"><font size="3">销售回款单【代币卡】</font></div>
</div>
...
<table class="cost" width="100%" border="1"
   ...
   <tr> 
	      ...
	      <td style="text-align: right">
	         <%=s.getSamount() - s.getRttao() - s.getSpayamount() %>
	      </td>
    </tr>
    <%}} %>
    </tbody>
