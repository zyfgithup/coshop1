...
<div class="x-panel-header">销售回款单【现金】</div>
<div><%@ include file="/common/messages.jsp"%></div>
<s:form action="exportExcelCash.do" id="ReceiveView" validate="true" method="POST">
<div align="center" style="width: 100%">
	<s:hidden name="model.id"  /> 
	<fieldset style="width: 92%; padding:10px 10px 10px 10px;">
	<legend>回款单【现金】</legend>
   ...
   <% 
     ...
     %>
      ...
      <tr height="23" bgcolor="#FFFFFF">
	      ...
	      <td style="text-align: right">
	         <fmt:formatNumber value="<%=s.getSamount() - s.getRttao() - (s.getSpayamount() - DoubleFormatUtil.format(s.getRealReturnMoney())) %>" pattern="#,##0.00"/>
	      </td>
	      <td>
