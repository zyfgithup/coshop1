 ...
 */
 function selectkh(){
    window.location.href="outKToReSiUI.do";
 } 
</script>
</head>
<body>
...
<div class="x-panel-header" >
	<div style="float: left;">销售回款管理【现金】</div>
...
<div class="x-toolbar">
      <table width="99%">
        <tr>
          <td>
          	<form action="${ctx}/receive/index.do" method="post">
          		状态：<s:select list='statusMap' name="model.redRed"></s:select>
          		<s:select list='receiveSalesReceiveinitMap' name="receiveSales"></s:select>          
...
<ec:table items="items" var="item" retrieveRowsCallback="limit" sortRowsCallback="limit" 
	...
	<ec:row>
		...
		<ec:column width="150" property="receiveNumber" title="编号" style="text-align:center"/>
