...
<title>销售退货单【现金】详情</title>
</head>
<body>
<div class="x-panel">
<div class="x-panel-header">销售退货单【现金】详情</div>
<s:form action="exportExcelCash.do" id="salesReturnsView" validate="true" method="POST">
<div align="center" style="width: 100%">
    ...
    <table width="100%">
        ...
        <tr>
			...
			<td align="right">实退金额：</td>
			<td align="left">
				<fmt:formatNumber value="${model.realReturnMoney }" pattern="#,##0.00"/>
			</td>
		</tr>
		<tr>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#D9D9D9">
  ...
  <tbody id="tbody">
   ...
   <tr height="23" bgcolor="#FFFFFF">
      ...
      <td align="right"><fmt:formatNumber value="<%=%>" pattern="#,##0.00"/></td>
      <td><%=s.getRemark()%>&nbsp;</td>
	...
	<table width="100%" style="margin-bottom: 10px;">
		<tr>
			<td style="text-align: center;">
			  ...
			  <a href="${ctx }/salesReturns/printCash.do?model.id=${model.id}" class="button">&nbsp;打印&nbsp;</a>
