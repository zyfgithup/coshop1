...
<div class="x-panel-header" >
	<div style="float: left;">销售退货管理【团购】</div>
</div>
...
<div class="x-toolbar">
      <table width="99%">
        <tr>
          <td>
          	<form action="${ctx}/salesReturns/cardIndex.do" method="post">
	            &nbsp;&nbsp;用户：<s:textfield name="name" size="10" id="name"/>
	                 <input type="hidden" name="model.salesType" value="g"/>
...
<ec:table items="items" var="item" retrieveRowsCallback="limit" sortRowsCallback="limit" 
	...
	<ec:row>
		...
		<ec:column width="180" property="_0" title="操作" viewsAllowed="html" style="text-align:center" sortable="false">
			 ...
			 |
			 <a href="groupSure.do?flag=card&model.id=${item.id}" title="确定退货操作">确定退货</a>|
			 <a href="groupCancel.do?flag=card&model.id=${item.id}" title="驳回退货请求">驳回请求</a>
			 </s:if>
