...
function selectSales(){
	var cus=window.showModalDialog(URL_PREFIX+"/pages/amol/sales/sales/cashSelector.jsp",null,"dialogWidth=55","dialogHeight=300px");
    if(cus!=null){
    	window.location.href="cashReturnUI.do?stId=" + cus.id;
	}
}
</script>
</head>
...
<s:form action="save" id="save" validate="true" method="POST">
	...
	<table align="center" width="95%">
		<tr>
			<td>
			<div align="left">
				<input name="button" type="button"	value="选择出库单" class="button" onclick="selectSales()">
				&nbsp;&nbsp;
				出库单：
