...
<%
	response.setHeader("Content-disposition","attachment; filename=SalesReturnsCash.xls"); 
%>
...
<div class="x-panel-header"><font size="3">销售退货单【现金】</font></div>
</div>
