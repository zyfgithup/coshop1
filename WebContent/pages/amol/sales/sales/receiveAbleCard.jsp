...
<div class="x-panel-header" >
	<div style="float: left;">应收账款【代币卡汇总】</div>
</div>
...
<div class="x-toolbar">
      <table width="99%">
        <tr>
          <td>
          	<form action="${ctx}/sales/receiveAbleCard.do" method="post">
		        ...
		        <input type="button" value="应收查询" onclick="window.location.href='${ctx}/sales/cardSales/queryCardIndex.do'" class="button"/>
           </form>
         </td>
       </tr>
     </table>
...
<ec:table items="items" var="item" retrieveRowsCallback="limit" sortRowsCallback="limit" 
		action="${ctx}/sales/receiveAbleCard.do"
		useAjax="true" doPreload="false"
		xlsFileName="应收账款（代币卡汇总）.xls"
