...
<div class="x-panel">
    ...
    <div class="x-toolbar">
        <form action="${ctx}/salesOrder/indextj.do" method="post">
            <table>
    ...
    <div class="x-panel-body">
        <ec:table items="items" var="item" retrieveRowsCallback="limit" sortRowsCallback="limit"
            ...
            <ec:row>
                ...
                <ec:column width="100" property="legalName" title="法人代表" ellipsis="true"/>
                <ec:column width="100" property="comAddress" title="注册地址" ellipsis="true"/>
