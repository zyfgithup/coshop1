...
public class DatabaseMethodDefinitionSource implements MethodDefinitionSource {
	...
	/**
	 * 
	 * @see {@link org.acegisecurity.intercept. ObjectDefinitionSource#getAttributes(Object)}
	 * @see {@link org.acegisecurity.intercept.method. AbstractMethodDefinitionSource#getAttributes(Object)}
	 * 
	 */
	...
	public ConfigAttributeDefinition getAttributes(Object object) {
		...
		if (object instanceof JoinPoint) { // 处理AspectJ方法拦截
			...
			String targetMethodName = joinPoint.getStaticPart().getSignature()
					.getName();
			Class[] types = ((CodeSignature) joinPoint.getStaticPart()
			...
			try {
				...
				throw new IllegalArgumentException(
						"Could not obtain target method from JoinPoint: "
								+ joinPoint);
			}
		}
	...
	/**
	 * @see {@link org.acegisecurity.intercept. ObjectDefinitionSource#getConfigAttributeDefinitions()}
	 */
	...
	/**
	 * @see {@link org.acegisecurity.intercept. ObjectDefinitionSource#supports(Class)}
	 */
	...
	protected ConfigAttributeDefinition lookupAttributes(Class clazz,
		...
		logger.debug("All authority of Method '{}' is {}", method.getName(),
				authStr);
