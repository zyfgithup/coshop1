...
public class ReturnsDetailAction extends
		DefaultCrudAction<PurchaseDetail,ReturnsDetailManager> {
	@Autowired
	...
	public String index() {
		...
		StringBuffer sql = new StringBuffer(
				"from PurchaseDetail pd where pd.purchase.status=0 and pd.purchase.user.id=? and pd.purchase.billType=2");
		...
		if (getModel() != null && getModel().getPurchase()!=null 
				&& getModel().getPurchase().getSupplier() != null
